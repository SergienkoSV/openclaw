...
export const FIELD_LABELS: Record<string, string> = {
  ...
  structuredDelivery: "Structured Delivery",
  "structuredDelivery.enabled": "Enable Structured Delivery",
  "structuredDelivery.delivery": "Structured Delivery Delivery",
  "structuredDelivery.delivery.hooks": "Contract-Specific Structured Delivery Hooks",
  "structuredDelivery.delivery.hooks.app_result": "App Result Hook",
  "structuredDelivery.delivery.hooks.app_result.path": "App Result Hook Script Path",
  "structuredDelivery.delivery.hooks.app_result.timeoutMs": "App Result Hook Timeout",
  "structuredDelivery.delivery.hooks.location_request": "Location Request Hook",
  "structuredDelivery.delivery.hooks.location_request.path": "Location Request Hook Script Path",
  "structuredDelivery.delivery.hooks.location_request.timeoutMs": "Location Request Hook Timeout",
  "structuredDelivery.retry": "Structured Delivery Retry",
  "structuredDelivery.retry.maxAttempts": "Max Validation Reprompts",
  "structuredDelivery.triggers": "Structured Delivery Triggers",
  "structuredDelivery.triggers[].tool": "Tool Name",
  "structuredDelivery.triggers[].mcpServer": "MCP Server",
  "structuredDelivery.triggers[].mcpTool": "MCP Tool",
  "structuredDelivery.triggers[].contract": "Delivery Contract",
  "structuredDelivery.triggers[].delivery": "Delivery Contract",
  "structuredDelivery.triggers[].copy": "Copy Preset",
  "structuredDelivery.triggers[].trusted": "Trusted Field Paths",
  "structuredDelivery.triggers[].trustedFields": "Trusted Field Paths",
  "structuredDelivery.triggers[].requiredTrusted": "Required Trusted Fields",
  "structuredDelivery.triggers[].requiredTrustedFields": "Required Trusted Fields",
